...
COPY = {
    ...
    'Week left':'本周剩余','Today used':'今日已记录','5h left':'5h 剩余',
    'Cached':'上次记录','Account quota':'账户额度','Update time unknown':'更新时间未知','Updated {time}':'更新于 {time}',
    'Observed since {time}':'自 {time} 起记录','Observation start unknown':'记录起点未知',
    'Local today · Tokens':'本机今日 · Token','Local cycle · Tokens':'本机周期 · Token',
    'Other recovery':'其他恢复','Other recovery is inferred; its source is unconfirmed.':'其他恢复为推定分类，具体来源尚未确认。',
...
TRANSLATIONS = {'zh-CN': COPY, 'ja': {
    ...
    'Week left':'今週の残り','Today used':'本日の記録分','5h left':'5h の残り',
    'Cached':'前回の記録','Account quota':'アカウント利用枠','Update time unknown':'更新時刻不明','Updated {time}':'更新 {time}',
    'Observed since {time}':'{time} から記録','Observation start unknown':'記録開始時刻不明',
    'Local today · Tokens':'ローカルの本日 · Token','Local cycle · Tokens':'ローカルの期間 · Token',
    'Other recovery':'その他の回復','Other recovery is inferred; its source is unconfirmed.':'その他の回復は推定の分類で、発生元は未確認です。',
    ...
    'Week left':'Semana restante','Today used':'Uso observado hoy','5h left':'5h restantes',
    ...
    'Observed since {time}':'Observado desde {time}','Observation start unknown':'Inicio de observación desconocido',
    'Local today · Tokens':'Hoy local · Tokens','Local cycle · Tokens':'Ciclo local · Tokens',
    'Other recovery':'Otra recuperación','Other recovery is inferred; its source is unconfirmed.':'Otra recuperación es una categoría inferida; su origen no está confirmado.',
