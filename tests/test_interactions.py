...
class InteractionTests(unittest.TestCase):
    ...
    def test_history_heading_identifies_units_and_legend_has_fixed_categories(self):
        ...
        for language,expected in [('en','20.37 100M'),('zh-CN','20.37 亿'),('ja','20.37 億'),('es','20.37 100M')]:
            ...
            self.assertNotIn(self.bar.label('Tokens'),labels);self.assertEqual(panel.history_choice.currentText(),panel.history_heading())
    ...
    def test_history_amount_labels_are_numeric_and_unit_is_in_heading(self):
        ...
        for language in app.LANGUAGES:
            ...
            self.assertFalse(panel.history_choice.isHidden())
    ...
    def test_both_languages_render_all_panels_and_cancel_reset(self):
        ...
        for language in app.LANGUAGES:
            ...
            for kind,key in ((app.TaskPopup,'Cycle · Tokens'),(app.SessionPopup,'Reset {time}'),(app.ResetPopup,'Reset periods')):
                ...
                elif kind is app.ResetPopup:self.assertEqual(panel.history_choice.currentText(),panel.history_heading())
