...
| 1.11 Reset history Token bar chart with independent quota percentages | Implemented, pushed and locally installed; Unreleased | Shared-scale Token bars, separate recorded quota column, aligned per-row units and chronology. 345 native tests (1 skipped), four-language renders, constrained-height scroll/pixel checks and matching installed build with preserved preferences. Public 0.10.1 remains unchanged. |
