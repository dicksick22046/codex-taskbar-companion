...
COPY = {
    'Usage history':'历史用量',
    'Reset periods':'重置周期',
    'Period usage ({unit})':'周期用量（{unit}）',
    'Estimated cost (USD)':'估算费用（美元）',
    'Estimated cost':'估算费用',
    'High / low':'最高/最低','Other days':'其他','No data':'无数据',
    'Quota used':'额度消耗',
    ...
    'Dismiss {status} for now':'本次收起：{status}','Task activity':'任务动态',
    ...
    'Rotate left-side indicators': '轮换左侧指标', 'Show indicator names':'显示指标名称', 'Week': '本周', 'Today': '今日',
...
TRANSLATIONS = {'zh-CN': COPY, 'ja': {
    ...
    'Period usage ({unit})':'期間別使用量（{unit}）',
    'Estimated cost (USD)':'推定費用（米ドル）',
    'Estimated cost':'推定費用',
    'High / low':'最高/最低','Other days':'その他','No data':'データなし',
    'Quota used':'利用枠使用率',
    ...
    'Dismiss {status} for now':'今回は非表示：{status}','Task activity':'タスクの動き',
    ...
    'Rotate left-side indicators': '左側の項目を順番に表示', 'Show indicator names':'項目名を表示', 'Week': '今週', 'Today': '今日',
    ...
    'Period usage ({unit})':'Uso por período ({unit})',
    'Estimated cost (USD)':'Coste estimado (USD)',
    'Estimated cost':'Coste estimado',
    'High / low':'Máx./mín.','Other days':'Otros','No data':'Sin datos',
    ...
    'Dismiss {status} for now':'Ocultar por ahora: {status}','Task activity':'Actividad de tareas',
    ...
    'Rotate left-side indicators': 'Alternar indicadores de la izquierda', 'Show indicator names':'Mostrar nombres de indicadores', 'Week': 'Semana', 'Today': 'Hoy',
