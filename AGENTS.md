...
- 当前交付范围见docs/specs/windows-companion.md，分阶段方向见docs/roadmap.md；Windows11 x64为已测试平台。保留Codex数据口径，不重新展开缺少证据的完整实时错误检测。
- 右键提供查找任务、设置与退出（见docs/specs/task-finding.md），设置内管理显示、启动和更新；主栏不添加外部大边框或反复提示。
